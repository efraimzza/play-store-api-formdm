...
public class GooglePlayAPI {
    ...
    public String generateAC2DMToken(String email, String oauthToken) throws IOException {
        Map<String, String> params = getDefaultAuthParams(email);
    ...
    public boolean acquire(String packageName, long versionCode, int offerType) throws IOException {
        AcquireRequest acquireRequest = AcquireRequest.newBuilder()
            .setPackage(
        ...
        String ACQUIRE_URL =FDFE_URL+ "/acquire";
        byte[] responseBytes = client.post(ACQUIRE_URL, acquireRequest.toByteArray(),getDefaultHeaders());
       // ResponseWrapper playResponse = ResponseWrapper.parseFrom(responseBytes);
/*
        DetailsResponse detailsResponse = w.getPayload().getDetailsResponse();
        return detailsResponse;
        
        PlayResponse playResponse = httpClient.post(
        ...
        try{
            AcquireResponseWrapper payload = AcquireResponseWrapper.parseFrom(responseBytes);

           // if (playResponse.isSuccessful()) {
            AcquireResponseWrapper.AcquireResponse.AcquirePayload.PurchaseWrapper purchase = payload.getAcquireResponse().getAcquirePayload().getPurchase();
  ...
  /*  public Payload genericGet(String url, Map<String, String> params) throws IOException {
   ...
   public Payload genericGet(String url, Map<String, String> params) throws IOException {
     ...
     */
    protected Map<String, String> getDefaultLoginParams(String email, String aasToken) throws GooglePlayException {
        Map<String, String> params = new HashMap<String, String>();
        ...
        if (this.gsfId != null && !this.gsfId.trim().isEmpty()) {
    ...
    protected Map<String, String> getDefaultAuthParams(String email) throws GooglePlayException {
        Map<String, String> params = new HashMap<String, String>();
        params.put("Email", email);
        /*try {
            params.put("EncryptedPasswd", PasswordEncrypter.encrypt(email, password));
    ...
    public static Map<String, String> getDefaultHeaders(
        ...
        headers.put("User-Agent", deviceInfoProvider.getUserAgentString());
        headers.put("X-DFE-Device-Id", gsfId);
        headers.put("Accept-Language", locale.toString().replace("_", "-"));
        headers.put("X-DFE-Encoded-Targets",
            "");
        headers.put("X-DFE-Phenotype",
            "H4sIAAAAAAAAAB3OO3KjMAAA0KRNuWXukBkBQkAJ2MhgAZb5u2GCwQZbCH_EJ77QHmgvtDtbv-Z9_H63zXXU0NVPB1odlyGy7751Q3CitlPDvFd8lxhz3tpNmz7P92CFw73zdHU2Ie0Ad2kmR8lxhiErTFLt3RPGfJQHSDy7Clw10bg8kqf2owLokN4SecJTLoSwBnzQSd652_MOf2_MOf2d1vKBNVedzg4ciPoLz2mQ8efGAgYeLou-l-PXn_7Sna1MfhHuySxt-4esulEDp8Sbq54CPPKjpANW-lkU2IZ0F92LBI-ukCKSptqeq1eXU96LD9nZfhKHdtjSWwJqUm_2r6pMHOxk01saVanmNopjX3YxQafC4iC6T55aRbC8nTI98AF_kItIQAJb5EQxnKTO7TZDWnr01HVPxelb9A2OWX6poidMWl16K54kcu_jhXw-JSBQkVcD_fPsLSZu6joIBAAA");
        ...
        headers.put("X-Limit-Ad-Tracking-Enabled", "false");
        headers.put("X-Ad-Id", "");
        headers.put("X-DFE-UserLanguages", locale.toString());
        headers.put("X-DFE-Request-Params", "timeoutMs=4000");

        String mccMnc = deviceInfoProvider.getMccmnc();
        if (mccMnc != null && !mccMnc.trim().isEmpty()) {
            headers.put("X-DFE-MCCMNC", mccMnc);
        }
        return headers;
    }
