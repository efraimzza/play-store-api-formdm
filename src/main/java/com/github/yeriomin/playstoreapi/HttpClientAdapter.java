...
public abstract class HttpClientAdapter {
    ...
    abstract public PlayResponse getNew(String url, Map<String, String> params, Map<String, String> headers) ;
    ...
    public PlayResponse getNew(String url, Map<String, String> params) {
        return getNew(url, params, new HashMap<String, String>());
    }
